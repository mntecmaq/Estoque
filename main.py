	...
	with st.form("form_cliente", clear_on_submit=True):
		...
		if submit_button:
			if nome_cli and fone_cli.isdigit():
					supabase.table("cliente").insert({"id", "nome_cli": nome_cli, "cpf_cli": cpf_cli, "fone_cli": fone_cli, "logradouro_cli": logradouro_cli, "num_cli": num_cli, "bairro_cli": bairro_cli, "obs_cli": obs_cli, "comp_cli": comp_cli,}).execute()
